...
* :new: <mark style="color:yellow;">Des évolutions de l'outil sont prévues</mark>. Dans le cadre de l’inventaire national des émissions de gaz à effet de serre pour la France, le Citepa améliore en continu le suivi des surfaces d’occupation des sols ainsi que l’estimation des flux de carbone associés à la gestion du territoire. Si, depuis la version MÉLÈZE (2026), les surfaces d’utilisation des terres d’ALDO sont cohérentes avec celles de l’inventaire SECTEN édition 2026, il est également prévu, dans les prochaines évolutions de l’outil, de renforcer la cohérence entre les méthodologies d'estimation des flux de carbone utilisées par le Citepa pour le secteur UTCATF et celles mises en œuvre dans ALDO.
...
C'est pourquoi il n'est pas possible de consulter sur ALDO les flux engendrés par les changements d'occupation du sol des données CITEPA et de les comparer avec l'état actuel. Sources : [Variations surfaciques](../introduction/sources.md#variations-de-surfaces-ha-an).
