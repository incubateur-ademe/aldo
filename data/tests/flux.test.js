...
describe('The flux data module', () => {
  ...
  const areaChangePath = '../dataByCommune/citepa-2004-2014.csv.json'
  it('returns change in surface area for given ground types from data file divided by 10, the number of years between studies (2004-2014)', () => {
    ...
    expect(getAnnualSurfaceChangeFromData({ commune: { insee: '01234' } }, 'prairies zones arborées', 'cultures')).toBe(1.2) // (5+7)/10 = 1.2
